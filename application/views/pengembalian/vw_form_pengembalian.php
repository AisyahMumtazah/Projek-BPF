                ...
                <div class="card-body">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="kode_peminjaman" value="<?= $peminjaman['kode_peminjaman'];?>"/>
                            ...
                            <input type="text" name="kode_peminjaman" value="<?= $peminjaman['kode_peminjaman'] ?>" class="form-control" id="kode_peminjaman" placeholder="Tanggal Pinjam" readonly>
                            <?= form_error('kode_peminjaman', '<small class="text-danger p1-3">', '</small>'); ?>
                        </div>
                        <div class="form-group">
                            <label for="id_buku">Id Buku</label>
                            <input type="text" name="id_buku" value="<?= $peminjaman['id_buku'] ?>" class="form-control" id="id_buku" placeholder="Tanggal Kembali" readonly>
                            <?= form_error('id_buku', '<small class="text-danger p1-3">', '</small>'); ?>
                        </div>
                        <div class="form-group">
                            <label for="id_anggota">Id Anggota</label>
                            <input type="text" name="id_anggota" value="<?= $peminjaman['id_anggota']  ?>" class="form-control" id="id_anggota" placeholder="Tanggal Pengembalian" readonly>
                            <?= form_error('id_anggota', '<small class="text-danger p1-3">', '</small>'); ?>
                        </div>
                        <div class="form-group">
                            <label for="tanggal_kembali">Tanggal Kembali</label>
                            <input type="text" name="tanggal_kembali" value="<?= $peminjaman['tanggal_kembali']  ?>" class="form-control" id="tanggal_kembali" placeholder="Tanggal Pengembalian" readonly>
