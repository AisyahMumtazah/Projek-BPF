                ...
                <div class="card-body">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="stok" value="<?= set_value('stok') ?>" class="form-control" id="stok" placeholder="Jumlah Stok">
                        ...
                        <button type="submit" name="tambah" class="btn btn-primary float-right">Tambah Data Sepatu</button>
                    </form>
                </div>
            </div>
        </div>
